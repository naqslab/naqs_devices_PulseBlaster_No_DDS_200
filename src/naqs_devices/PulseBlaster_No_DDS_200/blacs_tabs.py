#####################################################################
#                                                                   #
# /naqs_devices/Pulseblaster_No_DDS_200/blacs_tab.py             #
#                                                                   #
...
class PulseBlaster_No_DDS_200_Tab(Pulseblaster_No_DDS_Tab):
    ...
    def __init__(self,*args,**kwargs):
        self.device_worker_class = "naqs_devices.PulseBlaster_No_DDS_200.blacs_worker.PulseblasterNoDDS200Worker"
